      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl md:text-2xl text-gray-300 font-light">
            Real-time AI-powered camera processing
          </p>
        </div>
        ...
        <div className="mb-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50">
            ...
            <p className="text-gray-400 text-sm">Upload multiple images for AI training and processing</p>
          </div>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Live Processing</h3>
            <p className="text-gray-400 text-sm">Real-time camera feed with AI object detection</p>
          </div>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50">
            ...
            <p className="text-gray-400 text-sm">Get immediate AI-powered insights and analysis</p>
          </div>
        </div>
